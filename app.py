...
questions = [
	...
	'answer': ('b', 'East'), 
	'choices': [('a','North'), ('b', 'East'), ('c', 'South'), ('d','West')]
	},
	{
	'question': 'How many people live in Kenya?', 
	'answer': ('a', '49.7 million'), 
	'choices': [('a','49.7 million'), ('b', '22.5 million'), ('c', '65.1 million'), ('d','10.3 million')]
	},
	{
	'question': 'What is the capital of Kenya?', 
	'answer': ('c', 'Nairobi'), 
	'choices': [('a','Lagos'), ('b', 'Mombasa'), ('c', 'Nairobi'), ('d','Dakar')]
	},
	{
	'question': 'Aside from English, what\'s the national language?', 
	'answer': ('b', 'Swahili'), 
	'choices': [('a','kinyarwanda'), ('b', 'Swahili'), ('c', 'Igbo'), ('d','Setswana')]
	},
]
...
def ask_question(prompt):
	...
	question, answer, choices = [prompt[k] for k in ('question', 'answer', 'choices')]
	...
	if guess.lower() == answer[0]:
		print cowsay.tux('Yaaasss! %s, you right, you right it\'s %s' % (random.choice(glow_ups), answer[1]))
		correct_answers += 1
	else:
